...
class Fleet{
    ...
    // ***************************************************
  void recursiveDelete(Ship* aShip);
  void insertHelper(Ship* current, Ship* ship);
  void listHelper(Ship* aShip) const;
  void removeHelperRoot();
  void removeHelperOther(Ship* curr, int id);
  void removeLostHelper(Ship* aShip);
  void leftRotate(Ship* aShip);
  void rightRotate(Ship* aShip);
